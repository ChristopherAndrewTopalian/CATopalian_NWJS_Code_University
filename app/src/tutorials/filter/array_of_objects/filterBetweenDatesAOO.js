// filterBetweenDatesAOO.js
// returns only the items from an array of objects that have a date between the given start and end dates
...
function filterBetweenDatesAOO(whichArray, startDate, endDate)
{
    ...
    for (let z = 0; z < whichArray.length; z++)
    {
        ...
        // if the item's date is within the range (inclusive), add it to the result array
    ...
    // return the new array containing only items between the start and end dates
    return result;
}
...
// test the function
let filteredPeople = filterBetweenDatesAOO(
    people,
    "2024-01-01 00:00:00",
    "2024-12-31 23:59:59"
);
