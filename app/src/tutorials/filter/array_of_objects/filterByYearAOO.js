// filterByYearAOO.js
// returns only the items from an array of objects that have a date matching the given year (ignores month, day, and time)
...
function filterByYearAOO(whichArray, targetYear)
{
    ...
    // return the new array containing only items that match the given year
    return result;
}
...
// test the function
let filteredPeople = filterByYearAOO(
    people,
    2024
);
